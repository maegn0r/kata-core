...
public class MailTest {
    public static void main(String[] args) {
        ...
        String randomTo = "RandomReceiver";  // Некоторая случайная строка. Можете выбрать ее самостоятельно.
...
//   где по получателю можно получить список зарплат, которые были ему отправлены.
    ...
    public static class MailService<T> implements Consumer<Sendable<T>> {
        public static class MyHashMap<J, V> extends HashMap<J, V> {
            @Override
            public V get(Object key) {
                return (super.get(key) == null) ? (V) Collections.emptyList() : super.get(key);
            }
        }
